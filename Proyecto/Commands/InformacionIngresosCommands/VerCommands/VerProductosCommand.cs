...
{
    public class VerProductosCommand : CommandBase
    {
        InformacionIngresosVerViewModel _viewModel;
        public VerProductosCommand(InformacionIngresosVerViewModel viewModel)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            _viewModel.ViewModelPadre.InformacionIngresosVerProductosViewModel.Visibility = System.Windows.Visibility.Visible;
            _viewModel.ViewModelPadre.InformacionIngresosVerProductosViewModel.CargarProductosIngreso();
        }
    }
}
